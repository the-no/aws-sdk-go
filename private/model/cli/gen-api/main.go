...
import (
	...
	"github.com/the-no/aws-sdk-go/private/model/api"
...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/the-no/aws-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
