...
func (c *ResourceGroupsTaggingAPI) CreateResource(typ string, data []byte) (r aws.Referencer, attr aws.Attrabuter, err error) {
	return nil, nil, errors.New("Invail Resource Type!")
}

func (c *ResourceGroupsTaggingAPI) DeleteResource(typ string, r aws.Referencer) (err error) {
