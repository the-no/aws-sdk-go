...
import (
	...
	"github.com/the-no/aws-sdk-go/private/signer/v2"
)
...
func (c *SimpleDB) CreateResource(typ string, data []byte) (r aws.Referencer, attr aws.Attrabuter, err error) {
	return nil, nil, errors.New("Invail Resource Type!")
}

func (c *SimpleDB) DeleteResource(typ string, r aws.Referencer) (err error) {
