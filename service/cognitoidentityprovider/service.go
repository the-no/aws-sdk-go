...
func (c *CognitoIdentityProvider) CreateResource(typ string, data []byte) (r aws.Referencer, attr aws.Attrabuter, err error) {
	return nil, nil, errors.New("Invail Resource Type!")
}

func (c *CognitoIdentityProvider) DeleteResource(typ string, r aws.Referencer) (err error) {
