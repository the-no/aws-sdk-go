...
func (c *CodeCommit) CreateResource(typ string, data []byte) (r aws.Referencer, attr aws.Attrabuter, err error) {
	return nil, nil, errors.New("Invail Resource Type!")
}

func (c *CodeCommit) DeleteResource(typ string, r aws.Referencer) (err error) {
