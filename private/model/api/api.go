...
type API struct {
	...
	NoReferenceMethods bool
	NoAttrabuteMethods bool
...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/the-no/aws-sdk-go/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	a.imports["github.com/the-no/aws-sdk-go/aws/awsutil"] = true
	...
	if a.OperationHasOutputPlaceholder() {
		...
		a.imports["github.com/the-no/aws-sdk-go/private/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/the-no/aws-sdk-go/aws/credentials"] = true
			break
		}
	}
...
func (a *API) ServiceGoCode() string {
	...
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["github.com/the-no/aws-sdk-go/private/signer/v2"] = true
...
func (a *API) InterfaceGoCode() string {
	...
	a.imports = map[string]bool{
		"github.com/the-no/aws-sdk-go/aws":                true,
		"github.com/the-no/aws-sdk-go/aws/request":        true,
...
// computes the Reference chain for all  shapes
func (a *API) addReferences() {
	for _, o := range a.Operations {
		resolveShapeReference(o.InputRef.Shape)
		resolveShapeReference(o.OutputRef.Shape)
	}
}

func resolveShapeReference(s *Shape) {

	if ref, ok := s.MemberRefs[s.Reference]; ok {
		s.ReferenceAction = &ShapeReference{
			Name: s.Reference, Ref: ref,
		}
...
func (a *API) addAttrabutes() {
	for _, o := range a.Operations {
		resolveShapeAttrabutes(o.InputRef.Shape)
		resolveShapeAttrabutes(o.OutputRef.Shape)
	}
}
